...
class MovieCastDetails extends StatefulWidget {
  const MovieCastDetails({super.key, required this.movieId});
  final int movieId;

  @override
  State<MovieCastDetails> createState() => _MovieCastDetailsState();
}

class _MovieCastDetailsState extends State<MovieCastDetails> {
